...
namespace EventosWeb.Controllers    
{
    ...
    {
        private readonly EventosWebContext _context;

        public CotizacionsController(EventosWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Necesidad,Tipo,Lugar,Cuando,NDeInvitados,Descripcion")] Cotizacion cotizacion)
        {
